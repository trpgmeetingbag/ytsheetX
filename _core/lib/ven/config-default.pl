...
## ●タイトル
  our $title = 'ゆとシートＸ for Ventangle';
...
## ●各種ファイルへのパス
  ...
  our $lib_edit_char   = $::core_dir . '/lib/ven/edit-chara.pl';
  # 保存処理
  our $lib_save        = $::core_dir . '/lib/save.pl';
  our $lib_calc_char   = $::core_dir . '/lib/ven/calc-chara.pl';
  # シート表示
  our $lib_view        = $::core_dir . '/lib/view.pl';
  our $lib_view_char   = $::core_dir . '/lib/ven/view-chara.pl';
  # チャットパレット
  our $lib_palette     = $::core_dir . '/lib/palette.pl';
  our $lib_palette_sub = $::core_dir . '/lib/ven/palette-sub.pl';
  # 一覧
  our $lib_list_char   = $::core_dir . '/lib/ven/list-chara.pl';
  # JSON出力
  our $lib_json     = $::core_dir . '/lib/json.pl';
  our $lib_json_sub = $::core_dir . '/lib/ven/json-sub.pl';
  # コンバート
  our $lib_convert = $::core_dir . '/lib/ven/convert.pl';
